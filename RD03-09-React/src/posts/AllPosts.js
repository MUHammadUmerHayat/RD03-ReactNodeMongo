        ...
        <div className="row justify-content-center">
          {posts.map((p, idx) => (
            <div className="col-md-4 d-flex align-items-stretch" key={idx}>
              <div className="card mb-3" style={{border: '1px solid #888', boxShadow: '4px 4px 3px #888', width: '100%'}}>
                <div className="card-img-top bg-dark text-center" style={{height: '10vh'}}>
